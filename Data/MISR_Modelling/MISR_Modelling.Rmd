...
for(i in 1:nrow(pm25_aod_xgb_params)){
  ...
  PM25_AOD_xgb_pred <- predict(PM25_AOD_xgb, newdata = as.matrix(PM25_AOD.validation)[,2:15])
...
pm25_aod_xgb_best_RMSE <- which.min(pm25_aod_xgb_RMSE)
pm25_aod_xgb_best_R2 <- which.max(pm25_aod_xgb_R2)
