...
```{r test-train-validation-split, echo = FALSE, message = FALSE, warning = FALSE}
...
PM25_AOD_shuffle <- sample(c(1:nrow(PM25_AOD)))
PM25_AOD.train_indices = PM25_AOD_shuffle[1:round(nrow(PM25_AOD) * 0.7)]
PM25_AOD.validation_indices = PM25_AOD_shuffle[(round(nrow(PM25_AOD) * 0.7)+1):round(nrow(PM25_AOD) * 0.85)]
PM25_AOD.test_indices = PM25_AOD_shuffle[(round(nrow(PM25_AOD) * 0.85)+1):nrow(PM25_AOD)]
PM25_AOD.train <- PM25_AOD[PM25_AOD.train_indices,]
PM25_AOD.validation <- PM25_AOD[PM25_AOD.validation_indices,]
PM25_AOD.test <- PM25_AOD[PM25_AOD.test_indices,]
...
PM25_mixtures_shuffle <- sample(c(1:nrow(PM25_mixtures)))
PM25_mixtures.train_indices = PM25_mixtures_shuffle[1:round(nrow(PM25_mixtures) * 0.7)]
PM25_mixtures.validation_indices = PM25_mixtures_shuffle[(round(nrow(PM25_mixtures) * 0.7)+1):
                                                           round(nrow(PM25_mixtures) * 0.85)]
PM25_mixtures.test_indices = PM25_mixtures_shuffle[(round(nrow(PM25_mixtures) * 0.85)+1):nrow(PM25_mixtures)]
PM25_mixtures.train <- PM25_mixtures[PM25_mixtures.train_indices,]
PM25_mixtures.validation <- PM25_mixtures[PM25_mixtures.validation_indices,]
PM25_mixtures.test <- PM25_mixtures[PM25_mixtures.test_indices,]
```
